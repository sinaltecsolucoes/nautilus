    ...
    <head>
        ...
        <title><?= $pageTitle; ?> | NAUTILUS ERP</title>

        <link href="<?= $TEMA_BASE_URL; ?>/css/styles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed"
        ...
        data-page-module="<?= $data['pageScript'] ?? 'unknown'; ?>"
        data-debug="<?= getenv('APP_ENV') === 'dev' ? 'true' : 'false'; ?>">

        <!-- Navbar -->
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand ps-3" href="<?= BASE_URL; ?>/dashboard">NAUTILUS ERP</a>
            ...
            <ul class="navbar-nav ms-auto me-3">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown">
                        <i class="fas fa-user fa-fw"></i> <?= $usuarioNome; ?>
                    </a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseCadastros">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?= BASE_URL; ?>/fornecedores">Fornecedores</a>
                                    <a class="nav-link" href="<?= BASE_URL; ?>/transportadoras">Transportadoras</a>
                                    <a class="nav-link" href="<?= BASE_URL; ?>/veiculos">Veículos</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLogistica">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?= BASE_URL; ?>/expedicao">Expedição</a>
                                    <a class="nav-link" href="<?= BASE_URL; ?>/abastecimentos">Abastecimentos</a>
                                    <a class="nav-link" href="<?= BASE_URL; ?>/manutencao">Manutenção</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="<?= BASE_URL; ?>/permissoes">
        ...
        <script src="<?= $THEME_JS; ?>/scripts.js"></script>

        <!-- Script específico da página (entidades.js, funcionarios.js, etc.) -->
        <?php if (isset($data['pageScript'])) : ?>
            <script src="<?= BASE_URL; ?>/assets/js/<?= $data['pageScript']; ?>.js"></script>
        <?php endif; ?>
        <!-- ================================================================ -->
